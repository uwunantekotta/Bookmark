...
header { width: 100%; max-width: 1200px; margin: 18px auto 0; display: flex; justify-content: space-between; align-items: center; padding: 0 18px; z-index: 1; }
header h1 { font-family: 'Formula1 Display', sans-serif; font-size: 28px; margin: 0; }
nav a { margin-right: 18px; color: #fff; text-decoration: none; font-weight: 600; transition: 0.2s; }
...
.logout-btn { padding: 8px 12px; border-radius: 50px; border: 1px solid rgba(255,255,255,0.6); background: rgba(255,255,255,0.1); color: #fff; cursor: pointer; transition: 0.2s; font-size: 13px; font-weight: 600; }
.logout-btn:hover { background: rgba(255,255,255,0.2); }
.admin-btn { padding: 8px 16px; border-radius: 50px; border: none; background: #ffaa00; color: #000; text-decoration: none; font-weight: 700; font-size: 13px; transition: 0.2s; }
.admin-btn:hover { background: #ffc144; }
main { flex: 1; width: 100%; max-width: 1200px; margin: 30px auto; display: flex; gap: 24px; padding: 0 18px; z-index: 1; }
.column-left { flex: 1; }
...
<header>
    <h1><a href="{{ route('welcome') }}" style="color:white;text-decoration:none;">Audiobook</a></h1>
    <nav>
    ...
    <div class="auth-controls">
        @auth
            ...
            @endif
            <div class="user-info">Signed in as<br><strong>{{ Auth::user()->name }}</strong></div>
